...
- 於 GitHub 上[創建 Issue](https://github.com/HMCL-Community/HMCL-CE/issues/new/choose)，以報謬誤或求功能。
- 於 GitHub 上 Fork 倉庫，並[提交 Pull Request](https://github.com/HMCL-Community/HMCL-CE/compare)，以貢代碼。
