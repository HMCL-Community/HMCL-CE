...
3. **Stable Release** (End of month M+1)
   ...
   At the end of month M+1, if there are no ucepected issues, we will promote the latest stable preview `x.y.z` to the official release and push it to all users in the stable channel.
