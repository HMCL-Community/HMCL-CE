...
HMCL は以下の場所からダウンロードできます。

- [HMCL 公式サイト](https://github.com/HMCL-Community/HMCL-CE/releases/tag/v26.8-release.1)
- [GitHub Release](https://github.com/HMCL-Community/HMCL-CE/releases)

## 貢献

HMCL はコミュニティ主導のオープンソースプロジェクトであり、コードの貢献や提案を歓迎しています。

HMCL の開発には、次の方法で参加できます。

- GitHub で [Issue を作成](https://github.com/HMCL-Community/HMCL-CE/issues/new/choose)して、バグ報告や機能要望を行う。
- GitHub でリポジトリを fork し、[Pull Request を送信](https://github.com/HMCL-Community/HMCL-CE/compare)してコードを貢献する。

貢献する前に、以下の内容を含む[貢献ガイド](./Contributing.md)をお読みください。

- [ソースコードから HMCL をビルドして実行する方法](./Contributing.md#build-hmcl)
- [デバッグオプションで HMCL の動作を調整する方法](./Contributing.md#debug-options)
