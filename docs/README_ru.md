...
- [Официальный сайт HMCL](https://github.com/HMCL-Community/HMCL-CE/releases/tag/v26.8-release.1)
...
- Сообщайте об ошибках или предлагайте новые функции, [создав issue](https://github.com/HMCL-Community/HMCL-CE/issues/new/choose) на GitHub.
- Вносите код, сделав fork репозитория на GitHub и [отправив pull request](https://github.com/HMCL-Community/HMCL-CE/compare).
